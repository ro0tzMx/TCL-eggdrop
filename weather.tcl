        ...
        set black(weather.en.4) "\002%msg.1%\002 (%msg.2%) -- %msg.13% and %msg.3%$grade_sign C | \002Sensación térmica\002: %msg.4%$grade_sign C | \002Humedad\002: %msg.5%% | \002Wind\002: %msg.6% @ %msg.7% KPH | \002Presión atmosférica\002: %msg.8%mb | \002Nubes\002: %msg.9%% |  \002Posibilidad de lluvia\002: %msg.12%% | \002Índice UV\002: %msg.10% | \002última actualización\002: %msg.11%"
