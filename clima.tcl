...
set black(weather.en.4) "La Temperatura Actual en: \002%msg.1%\002 es de:  %msg.3%$grade_sign C | \002Sensación Termica\002: %msg.4%$grade_sign C | \002Humedad\002: %msg.5%% | \002Viento\002: %msg.7% km/h | \002Presión Atmoférica\002: %msg.8%mb | \002Nubosidad\002: %msg.9%% |  \002LLuvia\002: %msg.12%% | \002Índice UV\002: %msg.10% | \002Tiempo De Observación\002: %msg.11%"
...
set black(weather.en.7) "Sintaxis:Coloque \002%msg.1%clima ubicación,(m/f)\002 para obtener resultados."
set black(weather.en.8) "\002%msg.1%\002: su ubicación por defecto ha sido guardada:\002 %msg.2%\002 en \002%msg.3%\002 la base de datos."
set black(weather.en.9) "\002%msg.1%\002: no se encontro ninguna ubicación vinculada a tu nick. Para eso, use: \002%msg.2%clima <location,(m/f)>\002"
set black(weather.en.10) "Sintaxis:Coloque \002%msg.1%clima ubicación\002 para ver el clima actual."
