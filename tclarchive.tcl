...
set tclarchive(tcl_line) "\[TCL\] \002%tcl_name%\002 %tcl_version% ; \002Autor:\002 %author% ; \002Link de descarga:\002 %download_link% ; \002Cargado en fecha:\002 %date% ; \002Descripción:\002 %description%"
...
if {$found == "-1"} {
	putserv "PRIVMSG $chan :\[TCL\] No se ha encontrado resultados para \002$text\002"
	return
}
...
if {$type == "1"} {
	putserv "PRIVMSG $chan :\[TCL\] Encontrado \002$found\002 coincide ($page/$nr_pag páginas ; use -p \[nr\] para ver)"
} elseif {$type == "0"} {
